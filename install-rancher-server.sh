...
docker run -d --privileged -p 80:80 -p 443:443 -v /root/rancher:/var/lib/rancher  --restart=unless-stopped --name=rancher-server rancher/rancher:${rancher_version} --acme-domain ${rancher_server_url}
...
RANCHER_SERVER="https://${rancher_server_url}"
